...
CREATE TABLE "new_AssessmentAttemptQuestion" (
    ...
    "questionStartedAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
INSERT INTO "new_AssessmentAttemptQuestion" ("attemptId", "id", "position", "questionId") SELECT "attemptId", "id", "position", "questionId" FROM "AssessmentAttemptQuestion";
